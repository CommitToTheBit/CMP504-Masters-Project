...
public partial class Characterisation : Node
{
    ...
    {
        m_character = "ERROR: NULL CHARACTERISATION";
    ...
    {
        List<string> values = GetAttribute(attribute);
        return (values.Count > 0) ? values.First() : "ERROR: EMPTY CHARACTER ATTRIBUTE";
    }
