...
public partial class Script
{
    ...
    public Script(Dictionary<string, Characterisation> characterisations, int seed)
    {
        ...
        m_lines = LoadVertices(Environment.CurrentDirectory.Split("bin")[0] + "Assets/Dialogue/men_in_grey_suits_first_draft.json", characterisations.Keys.ToList());
    ...
    public string PrintInformationState(bool printCharacters = false, bool print = true)
    {
        string text = "";
